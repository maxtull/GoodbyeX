document.addEventListener('DOMContentLoaded', () => {
    ...
    // Logo
    waitForSelector('#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > header > div > div > div > div:nth-child(1) > div.css-175oi2r.r-dnmrzs.r-1559e4e > h1 > a > div > svg').then((logo) => {
        if (!logo) return;
    ...
    // Verified Tab
    waitForSelector('a[href="/i/premium_sign_up"] > div > div:nth-child(1) > svg').then((logo) => {
        if (!logo) return;
    ...
    new MutationObserver(() => {
        // New Tweet Button
        const tweetButton = document.querySelector('#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > main > div > div > div > div:nth-child(1) > div > div.css-175oi2r.r-kemksi.r-184en5c > div > div:nth-child(2) > div:nth-child(1) > div > div > div > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div > div > div > button > div > span > span');
        if (tweetButton && tweetButton.textContent != 'Tweet') {
            tweetButton.innerHTML = 'Tweet';
        }

        // Tweet Sidebar Button
        const tweetSidebarButton = document.querySelector('#react-root > div > div > div.css-175oi2r.r-1f2l425.r-13qz1uu.r-417010.r-18u37iz > header > div > div > div > div:nth-child(1) > div.css-175oi2r.r-e7q0ms.r-12kyg2d > a > div > span > div > div > span > span')
