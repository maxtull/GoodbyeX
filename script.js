document.addEventListener('DOMContentLoaded', () => {
    ...
    waitForSelector('link[rel="shortcut icon"]').then((faviconLink) => {
        if (faviconLink) {
            // Update the href attribute with your custom favicon URL
            faviconLink.href = "https://abs.twimg.com/favicons/twitter.2.ico";
        }
    });
